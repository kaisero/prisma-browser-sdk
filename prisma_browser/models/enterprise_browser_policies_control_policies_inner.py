...
class EnterpriseBrowserPoliciesControlPoliciesInner(BaseModel):
    """
    EnterpriseBrowserPoliciesControlPoliciesInner
    """ # noqa: E501
    policy: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Policy name from the Chromium policy catalog")
    value: Optional[Any] = Field(description="Policy value — can be any JSON type (string, boolean, number, object, or array) matching the policy's documented schema at https://chromeenterprise.google/policies/")
    __properties: ClassVar[List[str]] = ["policy", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EnterpriseBrowserPoliciesControlPoliciesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EnterpriseBrowserPoliciesControlPoliciesInner from a dict"""
        if obj is None:
            return None
