...
class InternalNetworkDetectionControlHostDetection(BaseModel):
    """
    Host-based internal network detection settings.
    """ # noqa: E501
    fqdn: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Internal-only FQDN to resolve.")
    expected_ip_addresses: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="Expected IPv4 addresses for the resolved FQDN.", alias="expectedIpAddresses")
    __properties: ClassVar[List[str]] = ["fqdn", "expectedIpAddresses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InternalNetworkDetectionControlHostDetection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InternalNetworkDetectionControlHostDetection from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "fqdn": obj.get("fqdn"),
            "expectedIpAddresses": obj.get("expectedIpAddresses")
        })
        return _obj
