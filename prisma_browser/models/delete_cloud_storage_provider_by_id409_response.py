...
class DeleteCloudStorageProviderById409Response(BaseModel):
    """
    ...
    rule_ids: Optional[List[StrictStr]] = Field(default=None, description="IDs of rules referencing this provider.", alias="ruleIds")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["code", "message", "ruleIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteCloudStorageProviderById409Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteCloudStorageProviderById409Response from a dict"""
        if obj is None:
            return None
