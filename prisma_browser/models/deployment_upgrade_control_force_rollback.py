...
class DeploymentUpgradeControlForceRollback(BaseModel):
    """
    Whether to force rollback when the pinned version is older than latest. Applies when mode is pinned. Defaults to false for both platforms when omitted.
    """ # noqa: E501
    mac: Optional[StrictBool] = Field(default=None, description="Whether to force macOS instances to roll back to the pinned version")
    windows: Optional[StrictBool] = Field(default=None, description="Whether to force Windows instances to roll back to the pinned version")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeploymentUpgradeControlForceRollback from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeploymentUpgradeControlForceRollback from a dict"""
        if obj is None:
            return None
