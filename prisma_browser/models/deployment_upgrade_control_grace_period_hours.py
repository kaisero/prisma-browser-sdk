...
class DeploymentUpgradeControlGracePeriodHours(LenientIntEnum):
    """
    Time in hours users can defer the forced update relaunch. Applies when mode is default, lts, or pinned. Defaults to 4 when omitted. Must not be set when mode is noUpdates.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DeploymentUpgradeControlGracePeriodHours from a JSON string"""
