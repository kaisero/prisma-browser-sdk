...
class AwsTenantCondition(BaseModel):
    """
    AwsTenantCondition
    """ # noqa: E501
    account_ids: Optional[Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1, max_length=100)]] = Field(default=None, description="List of allowed AWS account IDs", alias="accountIds")
    regions: Optional[Annotated[List[AwsTenantConditionRegionsInner], Field(min_length=1, max_length=100)]] = Field(default=None, description="List of allowed AWS regions")
    __properties: ClassVar[List[str]] = ["accountIds", "regions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AwsTenantCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AwsTenantCondition from a dict"""
        if obj is None:
            return None
