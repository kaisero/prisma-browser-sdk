...
class OnboardingWizardControlStepsPolicy(BaseModel):
    """
    Labels & Policy indicator step configuration.
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether the Labels & Policy indicator step is enabled.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsPolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsPolicy from a dict"""
        if obj is None:
            return None
