...
class AccessAndDataApplicationsApplicationGroups(BaseModel):
    """
    Application group references
    """ # noqa: E501
    application_group_ids: Optional[List[ApplicationGroupRef]] = Field(default=None, alias="applicationGroupIds")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["applicationGroupIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessAndDataApplicationsApplicationGroups from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in application_group_ids (list)
        _items = []
        if self.application_group_ids:
            for _item_application_group_ids in self.application_group_ids:
                if _item_application_group_ids:
                    _items.append(_item_application_group_ids.to_dict())
            _dict['applicationGroupIds'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessAndDataApplicationsApplicationGroups from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "applicationGroupIds": [ApplicationGroupRef.from_dict(_item) for _item in obj["applicationGroupIds"]] if obj.get("applicationGroupIds") is not None else None
        })
