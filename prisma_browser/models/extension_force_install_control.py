...
class ExtensionForceInstallControl(BaseModel):
    """
    Set specific extensions to be installed automatically in Prisma Browser.
    """ # noqa: E501
    extensions: Annotated[List[ExtensionForceInstallControlExtensionsInner], Field(max_length=100)] = Field(description="Extensions installed automatically in Prisma Browser")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExtensionForceInstallControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExtensionForceInstallControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "extensions": [ExtensionForceInstallControlExtensionsInner.from_dict(_item) for _item in obj["extensions"]] if obj.get("extensions") is not None else None
        })
        return _obj
