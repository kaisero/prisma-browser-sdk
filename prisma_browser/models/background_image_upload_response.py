...
class BackgroundImageUploadResponse(BaseModel):
    """
    BackgroundImageUploadResponse
    """ # noqa: E501
    background_image_id: StrictStr = Field(description="Background image asset identifier. Pass this value as-is to the `backgroundImage` control's `backgroundImageId` field.", alias="backgroundImageId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["backgroundImageId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackgroundImageUploadResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackgroundImageUploadResponse from a dict"""
        if obj is None:
            return None
