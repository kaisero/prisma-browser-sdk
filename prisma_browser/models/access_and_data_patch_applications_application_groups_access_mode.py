...
class AccessAndDataPatchApplicationsApplicationGroupsAccessMode(LenientStrEnum):
    """
    Whether this rule applies to no or specific application groups
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessAndDataPatchApplicationsApplicationGroupsAccessMode from a JSON string"""
