...
class BrandColorControlMode(LenientStrEnum):
    """
    Whether to use the default brand color or a custom one
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BrandColorControlMode from a JSON string"""
