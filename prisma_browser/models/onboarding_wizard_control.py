...
class OnboardingWizardControl(BaseModel):
    """
    Configure the end-user onboarding wizard.
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether the onboarding wizard is enabled.")
    steps: Optional[OnboardingWizardControlSteps] = None
    __properties: ClassVar[List[str]] = ["enabled", "steps"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnboardingWizardControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnboardingWizardControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "steps": OnboardingWizardControlSteps.from_dict(obj["steps"]) if obj.get("steps") is not None else None
        })
        return _obj
