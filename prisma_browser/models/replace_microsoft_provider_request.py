...
class ReplaceMicrosoftProviderRequest(BaseModel):
    """
    Request body to replace a Microsoft OneDrive provider (credential rotation).
    """ # noqa: E501
    tenant_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Azure AD tenant ID.", alias="tenantId")
    client_id: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Azure AD application (client) ID.", alias="clientId")
    client_secret: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Azure AD application client secret.", alias="clientSecret")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tenantId", "clientId", "clientSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReplaceMicrosoftProviderRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReplaceMicrosoftProviderRequest from a dict"""
        if obj is None:
            return None
