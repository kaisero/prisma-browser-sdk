...
class MaliciousFileProtectionControlProvider(LenientStrEnum):
    """
    ...
    allowed enum values
    """
    CROWDSTRIKEQUICKSCAN = 'crowdStrikeQuickScan'
    SAVAPISCAN = 'savapiScan'
    OPSWATMETADEFENDERCORE = 'opswatMetaDefenderCore'
    YAZAMTECH = 'yazamtech'
    VOTIRO = 'votiro'
    ADVANCEDWILDFIRE = 'advancedWildFire'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MaliciousFileProtectionControlProvider from a JSON string"""
