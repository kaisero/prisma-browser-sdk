...
class ProxyAutoConfigurationPacFileControlMode(LenientStrEnum):
    """
    Whether to configure a PAC file.
    """

    """
    allowed enum values
    """
    SETPACFILE = 'setPacFile'
    NOPACFILE = 'noPacFile'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ProxyAutoConfigurationPacFileControlMode from a JSON string"""
