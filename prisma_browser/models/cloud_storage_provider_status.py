...
class CloudStorageProviderStatus(LenientStrEnum):
    """
    Live connectivity status of the cloud storage provider.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CloudStorageProviderStatus from a JSON string"""
