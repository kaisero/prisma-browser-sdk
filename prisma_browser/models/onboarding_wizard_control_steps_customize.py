...
class OnboardingWizardControlStepsCustomize(BaseModel):
    """
    Customize step configuration.
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether the Customize step is enabled.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsCustomize from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsCustomize from a dict"""
        if obj is None:
            return None
