...
class SuggestDefaultBrowserControl(BaseModel):
    """
    Controls whether Prisma Browser suggests itself as the default browser to the user.
    """ # noqa: E501
    action: SuggestDefaultBrowserControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SuggestDefaultBrowserControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SuggestDefaultBrowserControl from a dict"""
        if obj is None:
            return None
