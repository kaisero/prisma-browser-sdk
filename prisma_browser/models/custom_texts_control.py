...
class CustomTextsControl(BaseModel):
    """
    Customize and edit texts shown in browser dialogs and block pages.
    """ # noqa: E501
    mode: CustomTextsControlMode
    overrides: Optional[Annotated[List[CustomTextsControlOverridesInner], Field(min_length=1, max_length=300)]] = Field(default=None, description="List of trigger-specific text overrides. Required when mode is customizeTexts. Must not be set when mode is useDefaultTexts.")
    __properties: ClassVar[List[str]] = ["mode", "overrides"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomTextsControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomTextsControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mode": obj.get("mode"),
            "overrides": [CustomTextsControlOverridesInner.from_dict(_item) for _item in obj["overrides"]] if obj.get("overrides") is not None else None
        })
        return _obj
