...
class TrafficFlowControlAction(LenientStrEnum):
    """
    How browser network traffic is routed through Prisma Access
    """

    """
    allowed enum values
    """
    PRIVATEAPPLICATIONTRAFFICONLY = 'privateApplicationTrafficOnly'
    ALLTRAFFIC = 'allTraffic'
    DONOTROUTETHROUGHPRISMAACCESS = 'doNotRouteThroughPrismaAccess'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TrafficFlowControlAction from a JSON string"""
