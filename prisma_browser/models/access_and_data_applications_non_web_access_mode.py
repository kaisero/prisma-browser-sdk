...
class AccessAndDataApplicationsNonWebAccessMode(LenientStrEnum):
    """
    Whether this rule applies to no, any, or specific non-web apps
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessAndDataApplicationsNonWebAccessMode from a JSON string"""
