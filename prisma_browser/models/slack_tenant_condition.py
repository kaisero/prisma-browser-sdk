...
class SlackTenantCondition(BaseModel):
    """
    SlackTenantCondition
    """ # noqa: E501
    workspace_names: Annotated[List[Annotated[str, Field(strict=True, max_length=100)]], Field(min_length=1, max_length=100)] = Field(description="List of allowed Slack workspace names", alias="workspaceNames")
    __properties: ClassVar[List[str]] = ["workspaceNames"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SlackTenantCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SlackTenantCondition from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "workspaceNames": obj.get("workspaceNames")
        })
        return _obj
