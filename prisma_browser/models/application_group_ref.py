...
class ApplicationGroupRef(BaseModel):
    """
    A reference to an application group entity.
    """ # noqa: E501
    id: StrictStr = Field(description="Application group identifier")
    name: StrictStr = Field(description="Application group display name")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationGroupRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationGroupRef from a dict"""
        if obj is None:
            return None
