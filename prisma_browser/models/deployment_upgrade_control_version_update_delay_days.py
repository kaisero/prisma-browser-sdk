...
class DeploymentUpgradeControlVersionUpdateDelayDays(LenientIntEnum):
    """
    Delay in days before receiving the latest default-channel version. Applies when mode is default.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DeploymentUpgradeControlVersionUpdateDelayDays from a JSON string"""
