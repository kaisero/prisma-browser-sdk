...
class FormSubmissionControlAction(LenientStrEnum):
    """
    Action for the form submission control.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FormSubmissionControlAction from a JSON string"""
