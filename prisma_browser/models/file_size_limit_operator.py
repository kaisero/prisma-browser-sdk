...
class FileSizeLimitOperator(LenientStrEnum):
    """
    Whether the rule applies to files smaller than or larger than the threshold.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FileSizeLimitOperator from a JSON string"""
