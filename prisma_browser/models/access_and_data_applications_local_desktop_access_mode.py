...
class AccessAndDataApplicationsLocalDesktopAccessMode(LenientStrEnum):
    """
    Whether this rule applies to no, any defined, or specific local desktop apps
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessAndDataApplicationsLocalDesktopAccessMode from a JSON string"""
