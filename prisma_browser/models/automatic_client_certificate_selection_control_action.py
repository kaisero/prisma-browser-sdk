...
class AutomaticClientCertificateSelectionControlAction(LenientStrEnum):
    """
    Whether automatic client certificate selection is enabled
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutomaticClientCertificateSelectionControlAction from a JSON string"""
