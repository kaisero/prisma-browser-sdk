...
class AutoLaunchExternalApplicationsControlRulesInner(BaseModel):
    """
    AutoLaunchExternalApplicationsControlRulesInner
    """ # noqa: E501
    protocol: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="External application protocol scheme")
    allowed_origins: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=2048)]], Field(min_length=1, max_length=100)] = Field(description="Origins allowed to launch the protocol without prompting", alias="allowedOrigins")
    __properties: ClassVar[List[str]] = ["protocol", "allowedOrigins"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AutoLaunchExternalApplicationsControlRulesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AutoLaunchExternalApplicationsControlRulesInner from a dict"""
        if obj is None:
            return None
