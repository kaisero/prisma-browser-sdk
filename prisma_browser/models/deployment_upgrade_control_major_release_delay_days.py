...
class DeploymentUpgradeControlMajorReleaseDelayDays(LenientIntEnum):
    """
    Delay in days before receiving the next available LTS major release. Applies when mode is lts.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DeploymentUpgradeControlMajorReleaseDelayDays from a JSON string"""
