...
class CustomLabel(BaseModel):
    """
    Custom address-bar label configuration. Required when addressBarLabel is 'custom'.
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=15)]] = Field(default=None, description="Display name for the custom label.")
    color: CustomLabelColor
    icon: CustomLabelIcon
    __properties: ClassVar[List[str]] = ["name", "color", "icon"]
