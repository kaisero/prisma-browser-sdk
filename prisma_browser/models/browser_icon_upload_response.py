...
class BrowserIconUploadResponse(BaseModel):
    """
    BrowserIconUploadResponse
    """ # noqa: E501
    browser_icon_id: StrictStr = Field(description="Browser icon asset identifier. Pass this value as-is to the `browserIcon` control's `browserIconId` field.", alias="browserIconId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["browserIconId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserIconUploadResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserIconUploadResponse from a dict"""
        if obj is None:
            return None
