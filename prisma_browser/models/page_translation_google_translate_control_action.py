...
class PageTranslationGoogleTranslateControlAction(LenientStrEnum):
    """
    How the Google Translation banner is offered.
    """

    """
    allowed enum values
    """
    ALWAYSOFFERTRANSLATION = 'alwaysOfferTranslation'
    NEVEROFFERTRANSLATION = 'neverOfferTranslation'
    ALLOWUSERCHOICE = 'allowUserChoice'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PageTranslationGoogleTranslateControlAction from a JSON string"""
