...
class AccessAndDataApplicationsSaas(BaseModel):
    """
    SaaS application scope
    """ # noqa: E501
    access_mode: AccessAndDataApplicationsSaasAccessMode = Field(alias="accessMode")
    specific: Optional[AccessAndDataApplicationsSaasSpecific] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessAndDataApplicationsSaas from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessAndDataApplicationsSaas from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "specific": AccessAndDataApplicationsSaasSpecific.from_dict(obj["specific"]) if obj.get("specific") is not None else None
        })
