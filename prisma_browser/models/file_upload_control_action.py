...
class FileUploadControlAction(LenientStrEnum):
    """
    ...
    """
    ALLOW = 'allow'
    ALLOWPROTECTEDBETWEENRULEAPPS = 'allowProtectedBetweenRuleApps'
    BLOCKONLYPROTECTED = 'blockOnlyProtected'
    BLOCK = 'block'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FileUploadControlAction from a JSON string"""
