...
class CloudStorageProvider(BaseModel):
    """
    A cloud storage provider integration.
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the provider.")
    display_name: StrictStr = Field(description="Human-readable name for the provider.", alias="displayName")
    type: CloudStorageProviderType
    enabled: StrictBool = Field(description="Whether the provider is enabled.")
    status: CloudStorageProviderStatus
    microsoft: Optional[MicrosoftProperties] = None
    google: Optional[GoogleProperties] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "displayName", "type", "enabled", "status", "microsoft", "google"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudStorageProvider from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if microsoft (nullable) is None
        # and model_fields_set contains the field
        if self.microsoft is None and "microsoft" in self.model_fields_set:
            _dict['microsoft'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudStorageProvider from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "microsoft": MicrosoftProperties.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "google": GoogleProperties.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
