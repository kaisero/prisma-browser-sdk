...
class UserAgentControlMode(LenientStrEnum):
    """
    Whether to use the default User-Agent or append an additional component.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserAgentControlMode from a JSON string"""
