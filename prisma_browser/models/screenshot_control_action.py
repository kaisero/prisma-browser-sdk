...
class ScreenshotControlAction(LenientStrEnum):
    """
    Screen-capture restriction. `allowSpecific` permits capture only via admin-selected mechanisms.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ScreenshotControlAction from a JSON string"""
