...
class AccessInputAddressBarLabel(LenientStrEnum):
    """
    Label shown in the browser address bar for matched pages.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessInputAddressBarLabel from a JSON string"""
