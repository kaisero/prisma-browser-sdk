...
class RequestDesktopMobileSiteControl(BaseModel):
    """
    Override default site settings for specific domains on mobile devices.
    """ # noqa: E501
    rules: Annotated[List[RequestDesktopMobileSiteControlRulesInner], Field(min_length=1, max_length=1000)] = Field(description="Desktop or mobile site overrides for selected domains.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RequestDesktopMobileSiteControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RequestDesktopMobileSiteControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "rules": [RequestDesktopMobileSiteControlRulesInner.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
