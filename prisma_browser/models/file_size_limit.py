...
class FileSizeLimit(BaseModel):
    ...
    """ # noqa: E501
    operator: FileSizeLimitOperator
    value: Annotated[int, Field(strict=True, ge=0)] = Field(description="The size threshold, expressed in the chosen unit. On read, value and unit are normalized to the largest unit that yields an exact integer (e.g. 1024 B is returned as 1 KB).")
    unit: FileSizeLimitUnit
    __properties: ClassVar[List[str]] = ["operator", "value", "unit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileSizeLimit from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileSizeLimit from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value"),
            "unit": obj.get("unit") if obj.get("unit") is not None else FileSizeLimitUnit.KB
        })
        return _obj
