...
class IdentityProviderSyncedShortcutsControlAction(LenientStrEnum):
    """
    Whether IDP-synced shortcuts are displayed.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IdentityProviderSyncedShortcutsControlAction from a JSON string"""
