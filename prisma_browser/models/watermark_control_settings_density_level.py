...
class WatermarkControlSettingsDensityLevel(LenientStrEnum):
    """
    Density of the watermark. Defaults to standard.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WatermarkControlSettingsDensityLevel from a JSON string"""
