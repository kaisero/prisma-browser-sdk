...
class MicrosoftProperties(BaseModel):
    """
    Microsoft OneDrive specific properties. Present only when type is microsoft.
    """ # noqa: E501
    tenant_id: StrictStr = Field(description="Azure AD tenant ID.", alias="tenantId")
    client_id: StrictStr = Field(description="Azure AD application (client) ID.", alias="clientId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MicrosoftProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MicrosoftProperties from a dict"""
        if obj is None:
            return None
