...
class DefaultAiProviderControlAction(LenientStrEnum):
    """
    Whether the default AI provider shortcut is shown.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DefaultAiProviderControlAction from a JSON string"""
