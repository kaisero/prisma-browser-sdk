...
class ApplicationRefAppType(LenientStrEnum):
    """
    Whether the app is from catalog or admin-defined
    """

    """
    allowed enum values
    """
    LOCALDESKTOPCATALOG = 'localDesktopCatalog'
    LOCALDESKTOPCUSTOM = 'localDesktopCustom'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApplicationRefAppType from a JSON string"""
