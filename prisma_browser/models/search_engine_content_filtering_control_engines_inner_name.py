...
class SearchEngineContentFilteringControlEnginesInnerName(LenientStrEnum):
    """
    Search engine name.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SearchEngineContentFilteringControlEnginesInnerName from a JSON string"""
