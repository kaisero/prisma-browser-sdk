...
class FileDownloadControlAction(LenientStrEnum):
    """
    ...
    """
    ALLOW = 'allow'
    USEINPRISMABROWSERONLY = 'useInPrismaBrowserOnly'
    SAVETOORGANIZATIONSTORAGE = 'saveToOrganizationStorage'
    BLOCK = 'block'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FileDownloadControlAction from a JSON string"""
