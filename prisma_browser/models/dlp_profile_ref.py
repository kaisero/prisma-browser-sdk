...
class DlpProfileRef(BaseModel):
    """
    Expanded reference to an Enterprise DLP (EDLP) data profile.
    """ # noqa: E501
    id: StrictStr = Field(description="EDLP data profile id (the external id from the Enterprise DLP API). Discover and validate profile ids via the EDLP Data Profiles API: list all with GET /v2/api/data-profiles, or fetch one with GET /v2/api/data-profiles/{resourceId}. Use this id as dlpProfileId when creating or updating a rule. ")
    name: StrictStr = Field(description="EDLP data profile display name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DlpProfileRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DlpProfileRef from a dict"""
        if obj is None:
            return None
