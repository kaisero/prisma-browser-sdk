...
class PageTranslationGoogleTranslateControl(BaseModel):
    """
    Control the Google Translation banner on foreign-language pages.
    """ # noqa: E501
    action: PageTranslationGoogleTranslateControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageTranslationGoogleTranslateControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageTranslationGoogleTranslateControl from a dict"""
        if obj is None:
            return None
