...
class DefaultAiProviderControl(BaseModel):
    """
    Selected provider will appear as a \"Prompt AI\" shortcut in the New Tab Page Enterprise Omnibox.
    """ # noqa: E501
    action: DefaultAiProviderControlAction
    provider: Optional[DefaultAiProviderControlProvider] = None
    __properties: ClassVar[List[str]] = ["action", "provider"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultAiProviderControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultAiProviderControl from a dict"""
        if obj is None:
            return None
