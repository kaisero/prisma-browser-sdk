...
class BackgroundImageControlBackgroundImageFilterMode(LenientStrEnum):
    """
    Whether to use the default image filter or set a custom filter overlay
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BackgroundImageControlBackgroundImageFilterMode from a JSON string"""
