...
class BrowserIconControl(BaseModel):
    """
    Set the icon for the browser in the operating system
    """ # noqa: E501
    mode: BrowserIconControlMode
    browser_icon_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=100)]] = Field(default=None, description="Browser icon asset identifier. Set `browserIconId` to the value returned by POST /assets/browser-icon.", alias="browserIconId")
    __properties: ClassVar[List[str]] = ["mode", "browserIconId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowserIconControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowserIconControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mode": obj.get("mode"),
            "browserIconId": obj.get("browserIconId")
        })
        return _obj
