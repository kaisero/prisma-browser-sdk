...
class FileTypeFilterOperator(LenientStrEnum):
    """
    Whether the rule applies to files in the combined list of predefinedTypes + customExtensions (in), or to all files except those (notIn).
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FileTypeFilterOperator from a JSON string"""
