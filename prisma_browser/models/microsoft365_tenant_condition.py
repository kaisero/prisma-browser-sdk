...
class Microsoft365TenantCondition(BaseModel):
    """
    Microsoft365TenantCondition
    """ # noqa: E501
    domains: Annotated[List[Annotated[str, Field(strict=True, max_length=2048)]], Field(min_length=1, max_length=100)] = Field(description="List of allowed Microsoft 365 domains")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Microsoft365TenantCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Microsoft365TenantCondition from a dict"""
        if obj is None:
            return None
