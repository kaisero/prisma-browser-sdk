...
class ClipboardControlOptionsAction(LenientStrEnum):
    """
    Action applied to this clipboard direction.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ClipboardControlOptionsAction from a JSON string"""
