...
class DeploymentUpgradeControlPatchDelayDays(LenientIntEnum):
    """
    Delay in days before receiving LTS security and bug patches. Applies when mode is lts. Must be less than or equal to majorReleaseDelayDays.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DeploymentUpgradeControlPatchDelayDays from a JSON string"""
