...
class WebUserInteractionControlSelectorsInner(BaseModel):
    """
    WebUserInteractionControlSelectorsInner
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Human-readable name of the element being hidden.")
    selector: Annotated[str, Field(min_length=1, strict=True, max_length=2048)] = Field(description="CSS selector identifying the element to hide on the page.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WebUserInteractionControlSelectorsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WebUserInteractionControlSelectorsInner from a dict"""
        if obj is None:
            return None
