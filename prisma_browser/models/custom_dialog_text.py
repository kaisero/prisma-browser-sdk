...
class CustomDialogText(BaseModel):
    """
    Custom dialog text shown to the user.
    """ # noqa: E501
    title: Annotated[str, Field(min_length=1, strict=True, max_length=80)] = Field(description="Dialog title.")
    description: Optional[Annotated[str, Field(strict=True, max_length=360)]] = Field(default=None, description="Main body text.")
    external_link: Optional[CustomDialogTextExternalLink] = Field(default=None, alias="externalLink")
    __properties: ClassVar[List[str]] = ["title", "description", "externalLink"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomDialogText from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomDialogText from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "externalLink": CustomDialogTextExternalLink.from_dict(obj["externalLink"]) if obj.get("externalLink") is not None else None
        })
        return _obj
