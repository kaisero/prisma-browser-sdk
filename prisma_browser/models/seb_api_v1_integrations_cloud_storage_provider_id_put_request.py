...
class SebApiV1IntegrationsCloudStorageProviderIdPutRequest(BaseModel):
    """
    SebApiV1IntegrationsCloudStorageProviderIdPutRequest
    """ # noqa: E501
    microsoft: Optional[ReplaceMicrosoftProviderRequest] = None
    google: Optional[ReplaceGoogleProviderRequest] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SebApiV1IntegrationsCloudStorageProviderIdPutRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SebApiV1IntegrationsCloudStorageProviderIdPutRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "microsoft": ReplaceMicrosoftProviderRequest.from_dict(obj["microsoft"]) if obj.get("microsoft") is not None else None,
            "google": ReplaceGoogleProviderRequest.from_dict(obj["google"]) if obj.get("google") is not None else None
        })
        return _obj
