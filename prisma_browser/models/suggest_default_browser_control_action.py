...
class SuggestDefaultBrowserControlAction(LenientStrEnum):
    """
    Whether Prisma Browser suggests becoming the default browser.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SuggestDefaultBrowserControlAction from a JSON string"""
