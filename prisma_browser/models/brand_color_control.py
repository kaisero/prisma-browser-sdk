...
class BrandColorControl(BaseModel):
    """
    Choose a brand color to be applied across all user-facing browser elements, including dialogs, block pages, and other elements
    """ # noqa: E501
    mode: BrandColorControlMode
    color: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Brand color applied to user-facing browser elements")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrandColorControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrandColorControl from a dict"""
        if obj is None:
            return None
