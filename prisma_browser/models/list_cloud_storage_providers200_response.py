...
class ListCloudStorageProviders200Response(BaseModel):
    """
    ListCloudStorageProviders200Response
    """ # noqa: E501
    providers: List[CloudStorageProvider]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCloudStorageProviders200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCloudStorageProviders200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "providers": [CloudStorageProvider.from_dict(_item) for _item in obj["providers"]] if obj.get("providers") is not None else None
        })
