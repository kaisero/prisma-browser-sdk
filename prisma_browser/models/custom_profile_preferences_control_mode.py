...
class CustomProfilePreferencesControlMode(LenientStrEnum):
    """
    Whether custom profile preferences are applied
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomProfilePreferencesControlMode from a JSON string"""
