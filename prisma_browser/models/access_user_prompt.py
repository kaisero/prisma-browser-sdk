...
class AccessUserPrompt(BaseModel):
    """
    How an end user is prompted before access is granted, and how long their decision is remembered.
    """ # noqa: E501
    mode: AccessUserPromptMode
    duration_minutes: Optional[AccessUserPromptDurationMinutes] = Field(default=None, alias="durationMinutes")
    __properties: ClassVar[List[str]] = ["mode", "durationMinutes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessUserPrompt from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessUserPrompt from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mode": obj.get("mode") if obj.get("mode") is not None else AccessUserPromptMode.WARNANDALLOW,
