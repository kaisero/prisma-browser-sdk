...
class PatchAccessAndDataRuleByIDRequest(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchAccessAndDataRuleByIDRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchAccessAndDataRuleByIDRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "mode": obj.get("mode"),
            "applications": AccessAndDataPatchApplications.from_dict(obj["applications"]) if obj.get("applications") is not None else None,
            ...
            "tracking": AccessAndDataPatchTracking.from_dict(obj["tracking"]) if obj.get("tracking") is not None else None
        })
