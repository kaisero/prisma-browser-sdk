...
class ReplaceGoogleProviderRequest(BaseModel):
    """
    Request body to replace a Google Drive provider (credential rotation).
    """ # noqa: E501
    email_address: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Google Workspace admin email for domain-wide delegation.", alias="emailAddress")
    service_account_key: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Base64-encoded Google service account JSON key.", alias="serviceAccountKey")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["emailAddress", "serviceAccountKey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReplaceGoogleProviderRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReplaceGoogleProviderRequest from a dict"""
        if obj is None:
            return None
