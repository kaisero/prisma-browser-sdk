...
class SearchSuggestionsControlAction(LenientStrEnum):
    """
    Whether live search suggestions are shown in the address bar.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SearchSuggestionsControlAction from a JSON string"""
