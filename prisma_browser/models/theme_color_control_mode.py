...
class ThemeColorControlMode(LenientStrEnum):
    """
    Whether end users choose their own theme color or the admin applies a fixed color.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ThemeColorControlMode from a JSON string"""
