...
class CustomTextsControlOverridesInnerLink(BaseModel):
    """
    Optional external link shown with the custom text
    """ # noqa: E501
    label: Annotated[str, Field(min_length=1, strict=True, max_length=30)] = Field(description="Link text displayed to the end user")
    url: Annotated[str, Field(min_length=1, strict=True, max_length=2000)] = Field(description="Link destination URL")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomTextsControlOverridesInnerLink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomTextsControlOverridesInnerLink from a dict"""
        if obj is None:
            return None
