...
class ApplicationRef(BaseModel):
    """
    A reference to an application entity.
    """ # noqa: E501
    id: StrictStr = Field(description="Application identifier")
    name: StrictStr = Field(description="Application display name")
    app_type: Optional[ApplicationRefAppType] = Field(default=None, alias="appType")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "appType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationRef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationRef from a dict"""
        if obj is None:
            return None
