...
class ManagedShortcutsControlMode(LenientStrEnum):
    """
    Whether managed shortcuts are configured
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ManagedShortcutsControlMode from a JSON string"""
