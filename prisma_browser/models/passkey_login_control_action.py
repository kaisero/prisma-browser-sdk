...
class PasskeyLoginControlAction(LenientStrEnum):
    """
    Whether to allow or block passkey-based logins.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PasskeyLoginControlAction from a JSON string"""
