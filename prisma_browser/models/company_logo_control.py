...
class CompanyLogoControl(BaseModel):
    """
    Set the logo displayed in the browser on dialogs, homepage, and other pages.
    """ # noqa: E501
    mode: CompanyLogoControlMode
    company_logo_id: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=100)]] = Field(default=None, description="Company logo asset identifier. Set `companyLogoId` to the value returned by POST /assets/company-logo.", alias="companyLogoId")
    __properties: ClassVar[List[str]] = ["mode", "companyLogoId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompanyLogoControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompanyLogoControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mode": obj.get("mode"),
            "companyLogoId": obj.get("companyLogoId")
        })
        return _obj
