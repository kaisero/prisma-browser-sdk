...
class AccessAndDataPostApplicationsPrivateSpecific(BaseModel):
    """
    Present when accessMode is specific
    """ # noqa: E501
    application_ids: Optional[Annotated[List[Annotated[str, Field(min_length=29, strict=True, max_length=29)]], Field(max_length=1000)]] = Field(description="A collection of up to 1000 unique Pulid strings.", alias="applicationIds")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessAndDataPostApplicationsPrivateSpecific from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessAndDataPostApplicationsPrivateSpecific from a dict"""
        if obj is None:
            return None
