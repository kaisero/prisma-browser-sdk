...
class FormLoginControlAction(LenientStrEnum):
    """
    Login restriction for form-based logins.
    """
    ...
    BLOCKALL = 'blockAll'
    BLOCKSPECIFICDOMAINS = 'blockSpecificDomains'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FormLoginControlAction from a JSON string"""
