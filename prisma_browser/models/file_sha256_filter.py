...
class FileSha256Filter(BaseModel):
    """
    Filter by SHA-256 file hashes.
    """ # noqa: E501
    operator: FileSha256FilterOperator
    hashes: Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1, max_length=100)] = Field(description="SHA-256 hashes of the files this rule should target — for example, hashes of known sensitive or known-good documents your organization wants to protect or whitelist. Submit hashes in any case (abc / ABC / aBc); GET responses always return lowercase.")
    __properties: ClassVar[List[str]] = ["operator", "hashes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileSha256Filter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileSha256Filter from a dict"""
        if obj is None:
            return None
