...
class ExtensionForceInstallControlExtensionsInnerSource(LenientStrEnum):
    """
    Extension source. When customURL, sourceUrl is required and must not be set for chromeWebstore.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExtensionForceInstallControlExtensionsInnerSource from a JSON string"""
