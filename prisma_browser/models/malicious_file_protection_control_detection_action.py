...
class MaliciousFileProtectionControlDetectionAction(LenientStrEnum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of MaliciousFileProtectionControlDetectionAction from a JSON string"""
