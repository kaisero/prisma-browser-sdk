...
class LivePageScanningControlAction(LenientStrEnum):
    """
    Whether real-time live page scanning is enabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of LivePageScanningControlAction from a JSON string"""
