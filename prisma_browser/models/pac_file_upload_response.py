...
class PacFileUploadResponse(BaseModel):
    """
    PacFileUploadResponse
    """ # noqa: E501
    pac_file_id: StrictStr = Field(description="PAC file asset identifier. Pass this value as-is to the `proxyAutoConfigurationPacFile` control's `pacFileId` field.", alias="pacFileId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["pacFileId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PacFileUploadResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PacFileUploadResponse from a dict"""
        if obj is None:
            return None
