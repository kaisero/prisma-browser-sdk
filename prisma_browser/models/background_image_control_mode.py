...
class BackgroundImageControlMode(LenientStrEnum):
    """
    New tab page background configuration
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BackgroundImageControlMode from a JSON string"""
