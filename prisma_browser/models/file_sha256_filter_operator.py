...
class FileSha256FilterOperator(LenientStrEnum):
    """
    Whether the rule applies to files whose hash is in the list (in), or to all files except those (notIn).
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FileSha256FilterOperator from a JSON string"""
