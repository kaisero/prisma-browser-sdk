...
class WatermarkControl(BaseModel):
    """
    Control webpage watermarking to deter users from taking screenshots using external means (e.g. mobile device).
    """ # noqa: E501
    action: WatermarkControlAction
    settings: Optional[WatermarkControlSettings] = None
    __properties: ClassVar[List[str]] = ["action", "settings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WatermarkControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WatermarkControl from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "settings": WatermarkControlSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
