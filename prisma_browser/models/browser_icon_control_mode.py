...
class BrowserIconControlMode(LenientStrEnum):
    """
    Whether a custom browser icon is configured
    """

    """
    allowed enum values
    """
    SETBROWSERICON = 'setBrowserIcon'
    USEPRISMABROWSERICON = 'usePrismaBrowserIcon'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of BrowserIconControlMode from a JSON string"""
