...
class CustomBrowserPreferencesControlMode(LenientStrEnum):
    """
    Whether custom browser preferences are applied
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomBrowserPreferencesControlMode from a JSON string"""
