...
class OnBrowserStartupControlAction(LenientStrEnum):
    """
    ...
    RESTOREPREVIOUSSESSIONANDOPENURLS = 'restorePreviousSessionAndOpenUrls'
    OPENNEWTABPAGE = 'openNewTabPage'
    OPENURLS = 'openUrls'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OnBrowserStartupControlAction from a JSON string"""
