...
class EnterpriseBrowserPoliciesControlMode(LenientStrEnum):
    """
    Whether enterprise browser policies are applied
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EnterpriseBrowserPoliciesControlMode from a JSON string"""
