...
class PrintControlAction(LenientStrEnum):
    """
    Whether to allow or block printing of web pages and files opened in Prisma Browser.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrintControlAction from a JSON string"""
