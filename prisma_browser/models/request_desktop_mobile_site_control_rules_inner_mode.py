...
class RequestDesktopMobileSiteControlRulesInnerMode(LenientStrEnum):
    """
    Requested site mode for the domain.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RequestDesktopMobileSiteControlRulesInnerMode from a JSON string"""
