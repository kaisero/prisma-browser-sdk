...
class WatermarkControlSettingsRotationDegrees(LenientStrEnum):
    """
    Rotation angle of the watermark in degrees. Defaults to \"0\".
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WatermarkControlSettingsRotationDegrees from a JSON string"""
