...
class SearchSuggestionsControl(BaseModel):
    """
    Show live search suggestions in the address bar as users type.
    """ # noqa: E501
    action: SearchSuggestionsControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchSuggestionsControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchSuggestionsControl from a dict"""
        if obj is None:
            return None
