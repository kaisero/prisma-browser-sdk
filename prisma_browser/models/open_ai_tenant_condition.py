...
class OpenAITenantCondition(BaseModel):
    """
    OpenAITenantCondition
    """ # noqa: E501
    account_ids: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=100)]], Field(min_length=1, max_length=100)]] = Field(default=None, description="List of allowed OpenAI account IDs", alias="accountIds")
    domains: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=2048)]], Field(min_length=1, max_length=100)]] = Field(default=None, description="List of allowed OpenAI domains")
    __properties: ClassVar[List[str]] = ["accountIds", "domains"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAITenantCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAITenantCondition from a dict"""
        if obj is None:
            return None
