...
class TrafficFlowControl(BaseModel):
    """
    Choose the way the Prisma Browser handles network traffic.
    """ # noqa: E501
    action: TrafficFlowControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrafficFlowControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrafficFlowControl from a dict"""
        if obj is None:
            return None
