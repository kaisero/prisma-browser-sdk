...
class CustomNoticeControlAction(LenientStrEnum):
    """
    Whether the custom notice is shown.
    """
    ...
    DONOTSHOWNOTICE = 'doNotShowNotice'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomNoticeControlAction from a JSON string"""
