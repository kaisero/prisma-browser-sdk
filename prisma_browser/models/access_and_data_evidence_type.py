...
class AccessAndDataEvidenceType(LenientStrEnum):
    """
    Evidence capture type for access and data tracking.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessAndDataEvidenceType from a JSON string"""
