...
class AccessAndDataApplicationsSaasAccessMode(LenientStrEnum):
    """
    Whether this rule applies to no, any, or specific SaaS apps
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessAndDataApplicationsSaasAccessMode from a JSON string"""
