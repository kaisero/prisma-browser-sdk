...
class UserPrompt(BaseModel):
    """
    How an end user is prompted before a control's restriction is applied, and how long their decision is remembered. Optional; absence is equivalent to { mode: \"none\" } — no prompt is shown.
    """ # noqa: E501
    mode: UserPromptMode
    duration_minutes: Optional[OverrideDurationMinutes] = Field(default=None, alias="durationMinutes")
