...
class DefaultSearchProviderControlAction(LenientStrEnum):
    """
    Whether the default search provider is managed.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DefaultSearchProviderControlAction from a JSON string"""
