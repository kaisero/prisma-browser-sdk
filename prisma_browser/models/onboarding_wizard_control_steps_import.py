...
class OnboardingWizardControlStepsImport(BaseModel):
    """
    Import step configuration.
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether the Import step is enabled.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsImport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsImport from a dict"""
        if obj is None:
            return None
