...
class AutoLaunchExternalApplicationsControlAction(LenientStrEnum):
    """
    Whether matching websites can bypass the external application launch prompt
    """
    ...
    ALWAYSPROMPTUSER = 'alwaysPromptUser'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AutoLaunchExternalApplicationsControlAction from a JSON string"""
