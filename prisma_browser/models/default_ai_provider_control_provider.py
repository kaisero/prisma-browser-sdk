...
class DefaultAiProviderControlProvider(LenientStrEnum):
    """
    Default AI provider shown as the \"Prompt AI\" shortcut.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DefaultAiProviderControlProvider from a JSON string"""
