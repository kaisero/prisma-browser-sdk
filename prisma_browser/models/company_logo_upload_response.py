...
class CompanyLogoUploadResponse(BaseModel):
    ...
    """ # noqa: E501
    company_logo_id: StrictStr = Field(description="Company logo asset identifier. Pass this value as-is to the `companyLogo` control's `companyLogoId` field.", alias="companyLogoId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["companyLogoId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CompanyLogoUploadResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CompanyLogoUploadResponse from a dict"""
        if obj is None:
            return None
