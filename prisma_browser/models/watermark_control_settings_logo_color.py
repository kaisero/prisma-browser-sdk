...
class WatermarkControlSettingsLogoColor(LenientStrEnum):
    """
    Color of the watermark logo. Defaults to white.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WatermarkControlSettingsLogoColor from a JSON string"""
