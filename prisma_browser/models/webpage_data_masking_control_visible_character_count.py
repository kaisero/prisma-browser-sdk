...
class WebpageDataMaskingControlVisibleCharacterCount(LenientStrEnum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebpageDataMaskingControlVisibleCharacterCount from a JSON string"""
