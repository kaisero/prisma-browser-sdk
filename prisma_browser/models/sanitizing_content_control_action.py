...
class SanitizingContentControlAction(LenientStrEnum):
    """
    Action for the sanitizing content control.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SanitizingContentControlAction from a JSON string"""
