...
class RestrictedRuleMode(LenientStrEnum):
    """
    The mode of the rule. The 'monitor' mode is not supported for this rule type.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RestrictedRuleMode from a JSON string"""
