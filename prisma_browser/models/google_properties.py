...
class GoogleProperties(BaseModel):
    """
    Google Drive specific properties. Present only when type is google.
    """ # noqa: E501
    email_address: StrictStr = Field(description="Google Workspace admin email for domain-wide delegation.", alias="emailAddress")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GoogleProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GoogleProperties from a dict"""
        if obj is None:
            return None
