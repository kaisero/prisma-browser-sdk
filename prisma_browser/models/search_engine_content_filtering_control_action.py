...
class SearchEngineContentFilteringControlAction(LenientStrEnum):
    """
    Whether search engine content filtering is enabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SearchEngineContentFilteringControlAction from a JSON string"""
