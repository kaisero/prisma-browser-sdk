...
class CustomTextsControlMode(LenientStrEnum):
    """
    Whether browser text overrides are configured
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomTextsControlMode from a JSON string"""
