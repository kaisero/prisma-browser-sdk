...
class CreatedIdResponse(BaseModel):
    ...
    CreatedIdResponse
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier of the created resource (PULID, 29 chars).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatedIdResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatedIdResponse from a dict"""
        if obj is None:
            return None
