...
class OnboardingWizardControlStepsWelcomeLink(BaseModel):
    """
    Optional Welcome step link.
    """ # noqa: E501
    label: Annotated[str, Field(min_length=1, strict=True, max_length=30)] = Field(description="Link label.")
    url: Annotated[str, Field(strict=True, max_length=2000)] = Field(description="A web URL: an absolute http(s)/ftp URL, or a schemeless host (e.g. \"example.com\"). Dangerous schemes (javascript:, data:, …) are rejected. Precise host rules are enforced server-side.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsWelcomeLink from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsWelcomeLink from a dict"""
        if obj is None:
            return None
