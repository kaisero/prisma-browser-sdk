...
class CompanyNameControlMode(LenientStrEnum):
    """
    Whether to display a company name or no name
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CompanyNameControlMode from a JSON string"""
