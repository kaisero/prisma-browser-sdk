...
class WebUserInteractionControlAction(LenientStrEnum):
    """
    Whether web user interaction control is enabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebUserInteractionControlAction from a JSON string"""
