...
class InternalNetworkDetectionControlAction(LenientStrEnum):
    """
    Whether internal network detection is enabled.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of InternalNetworkDetectionControlAction from a JSON string"""
