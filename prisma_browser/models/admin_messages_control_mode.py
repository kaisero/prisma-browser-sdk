...
class AdminMessagesControlMode(LenientStrEnum):
    """
    Whether admin messages appear on the new tab page
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AdminMessagesControlMode from a JSON string"""
