...
class OnboardingWizardControlStepsWelcome(BaseModel):
    """
    Welcome step configuration.
    """ # noqa: E501
    enabled: StrictBool = Field(description="Whether the Welcome step is enabled.")
    title: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=160)]] = Field(default=None, description="Custom title for the Welcome step.")
    description: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=320)]] = Field(default=None, description="Custom description for the Welcome step.")
    link: Optional[OnboardingWizardControlStepsWelcomeLink] = None
    __properties: ClassVar[List[str]] = ["enabled", "title", "description", "link"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsWelcome from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnboardingWizardControlStepsWelcome from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "link": OnboardingWizardControlStepsWelcomeLink.from_dict(obj["link"]) if obj.get("link") is not None else None
        })
        return _obj
