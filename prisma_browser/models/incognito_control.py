...
class IncognitoControl(BaseModel):
    """
    Control the ability to open Prisma Browser in Incognito mode.
    """ # noqa: E501
    action: IncognitoControlAction
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IncognitoControl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IncognitoControl from a dict"""
        if obj is None:
            return None
