...
class ManagedShortcutsControlShortcutsInner(BaseModel):
    """
    ManagedShortcutsControlShortcutsInner
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Shortcut display name")
    url: Annotated[str, Field(min_length=1, strict=True, max_length=2048)] = Field(description="Shortcut destination URL")
    shortcut_icon_id: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Shortcut icon asset identifier", alias="shortcutIconId")
    pinned: Optional[StrictBool] = Field(default=None, description="Whether the shortcut is pinned")
    __properties: ClassVar[List[str]] = ["name", "url", "shortcutIconId", "pinned"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ManagedShortcutsControlShortcutsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ManagedShortcutsControlShortcutsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "url": obj.get("url"),
            "shortcutIconId": obj.get("shortcutIconId"),
