...
class AccessUserPromptMode(LenientStrEnum):
    """
    What the user sees when the access restriction triggers.
    """
    ...
    """
    NONE = 'none'
    WARNANDALLOW = 'warnAndAllow'
    PROCEEDWITHREASON = 'proceedWithReason'
    ADMINAPPROVAL = 'adminApproval'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessUserPromptMode from a JSON string"""
