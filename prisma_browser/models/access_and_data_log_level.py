...
class AccessAndDataLogLevel(LenientStrEnum):
    """
    Log privacy level for access and data tracking.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AccessAndDataLogLevel from a JSON string"""
