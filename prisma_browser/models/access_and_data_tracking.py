...
class AccessAndDataTracking(BaseModel):
    """
    Tracking and logging configuration for the rule
    """ # noqa: E501
    log_level: AccessAndDataLogLevel = Field(alias="logLevel")
    should_log_query_params: Optional[StrictBool] = Field(default=None, description="Whether to log URL query parameters. Only present when logLevel is 'on'.", alias="shouldLogQueryParams")
    evidence_type: Optional[AccessAndDataEvidenceType] = Field(default=None, alias="evidenceType")
    session_recording: StrictBool = Field(description="Whether session recording is enabled", alias="sessionRecording")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessAndDataTracking from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessAndDataTracking from a dict"""
        if obj is None:
            return None
