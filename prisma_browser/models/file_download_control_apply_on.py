...
class FileDownloadControlApplyOn(LenientStrEnum):
    """
    Whether the download rule applies to every file (any) or only to files that match the filters below (specific).
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FileDownloadControlApplyOn from a JSON string"""
