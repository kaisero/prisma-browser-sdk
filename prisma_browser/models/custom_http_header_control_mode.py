...
class CustomHttpHeaderControlMode(LenientStrEnum):
    """
    Whether to keep default headers or add a custom header.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomHttpHeaderControlMode from a JSON string"""
